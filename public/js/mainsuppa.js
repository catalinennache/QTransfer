jQuery(document).ready(function () {
    ...
    {
        jQuery("html, .menu-left-part, #cbp-bislideshow.scroll").niceScroll({cursorcolor: "#6195FF", scrollspeed: 100, mousescrollstep: 100, cursorwidth: "12px", cursorborder: "none", cursorborderradius: "0px"});
...
jQuery(document).ready(function(){
    ...
    jQuery('.social-list').toggleClass('expnd');
},700);
})
